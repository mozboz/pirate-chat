...
# 20120421 added userdirs
    global picture, message, port, directory, must_save_options , hostname_pb , piratebox_chat , userdirs
...
# 20110314 - Added Hostname as opt
        opts, args = getopt.gnu_getopt(cmd, "c:H:p:m:u:d:h",
                                       ["chatbox=","hostname=","picture=","message=",
                                        "directory=", "help","userdirs",
...
# 20120401 Start
            ...
            piratebox_chat = a 
# 20120401 End
        elif o in ["-u", "--userdirs" ] :
            userdirs = True
            print "userdirs are %s" %userdirs
        elif o in ["-m", "--message"] :
            message = a
